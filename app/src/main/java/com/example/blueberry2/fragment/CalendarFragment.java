...
public class CalendarFragment extends Fragment {
    ...
    public void onStart() {
        ...
        //overridePendingTransition(R.anim.fadein, R.anim.hold);  - fade 효과 주기 / fragment로 자동적으로 넘어가면 사용안해도 됨

        calendarView=getView().findViewById(R.id.calendarView);
        diaryTextView=getView().findViewById(R.id.diaryTextView);
        save_Btn=getView().findViewById(R.id.save_Btn);
        del_Btn=getView().findViewById(R.id.del_Btn);
        cha_Btn=getView().findViewById(R.id.cha_Btn);
        textView2=getView().findViewById(R.id.textView2);
        textView3=getView().findViewById(R.id.textView3);
        contextEditText=getView().findViewById(R.id.contextEditText);
