...
public class MyYearMonthPickerDialog extends DialogFragment {
    ...
    public Dialog onCreateDialog(Bundle savedInstanceState) {
        ...
        btnCancel.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View view) {
                ...
                listener.onDateSet(null, 2022,11, 0);
        ...
        btnConfirm.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View view) {
                getYearandMonth getyearandmonth =new getYearandMonth();
                getyearandmonth.getYandM(yearPicker.getValue(), monthPicker.getValue());
    ...
    class getYearandMonth{
        private String year;
        private String month;

        public void getYandM(Integer year, Integer month){
